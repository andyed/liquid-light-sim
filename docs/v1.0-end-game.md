...
**Next Steps:**
- Investigate and fix the lack of coupling between the water and oil layers. The oil is not responding to the water's movement, which is preventing the desired dynamic behavior.
- Tune the surface tension and coupling parameters to achieve the desired "blobby" look and feel.
