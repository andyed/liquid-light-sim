...
- **WebGL2 Texture Format Robustness**: We discovered that `gl.RG16F` (half-float) for velocity textures can be inconsistent across hardware/drivers, and `gl.RG32F` (full-float) is a more robust choice for WebGL2.
