...
✅ Ink dissipation/inflation fixed (switched to semi-Lagrangian advection)  
...
⚠️ Oil still dissolves into pixel dust rather than blobs splitting off the main (advection is too dissipative)  
...
1. **Oil Advection Dissipation** ✅
   - Problem: Oil was dissolving into "pixel dust" because the semi-Lagrangian advection was too dissipative.
   ...
   - Result: Oil is more cohesive and less prone to dissolving.

2. **Surface Tension Tuning** ✅
...
3. **Oil Composite Shader Simplification** ✅
