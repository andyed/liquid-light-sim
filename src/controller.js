...
export default class Controller {
    constructor(simulation, renderer) {
        ...
        this.materials = [
            ...
            { name: 'Mineral Oil', palette: ['#FFF3C4', '#FFD166', '#F6BD60', '#F7EDE2', '#F28482'], preset: { oilSmoothingRate: 0.0, oilViscosity: 0.08, oilViscosityIterations: 40, couplingStrength: 0.7, absorption: 3.5, paletteDom: 0.12, refractStrength: 0.0075, fresnelPower: 3.0, oilOcclusion: 0.15, oilAlphaGamma: 1.80, marangoniStrength: 1.2, marangoniKth: 1.5, marangoniEdgeBand: 3.0, marangoniThMin: 0.01, marangoniForceClamp: 0.15, marangoniAmp: 5.0, oilAttractionStrength: 0.0, surfaceTension: 0.0002, oilOverflowUpper: 0.93, oilOverflowLower: 0.78 } },
            { name: 'Alcohol', palette: ['#BDE0FE', '#A2D2FF', '#CDB4DB', '#FFC8DD', '#FFAFCC'], preset: { oilViscosity: 0.1, oilViscosityIterations: 20, couplingStrength: 0.6, absorption: 2.5, paletteDom: 0.20, refractStrength: 0.007, fresnelPower: 2.8, oilOcclusion: 0.30, oilAlphaGamma: 0.90, marangoniKth: 0.4, marangoniEdgeBand: 1.5, surfaceTension: 0.0001, oilOverflowUpper: 0.91, oilOverflowLower: 0.76 } },
            { name: 'Syrup', palette: ['#8B4513', '#D2691E', '#C97A36', '#F4A261', '#E76F51'], preset: { oilViscosity: 0.5, oilViscosityIterations: 60, couplingStrength: 0.7, absorption: 4.0, paletteDom: 0.12, refractStrength: 0.012, fresnelPower: 3.2, oilOcclusion: 0.60, oilAlphaGamma: 1.20, marangoniKth: 1.0, marangoniEdgeBand: 2.5, surfaceTension: 0.0005, oilOverflowUpper: 0.95, oilOverflowLower: 0.80, occupancyEveryN: 180 } },
            { name: 'Glycerine', palette: ['#E0FBFC', '#98C1D9', '#3D5A80', '#EE6C4D', '#293241'], preset: { oilViscosity: 0.3, oilViscosityIterations: 40, couplingStrength: 0.8, absorption: 4.5, paletteDom: 0.10, refractStrength: 0.015, fresnelPower: 3.5, oilOcclusion: 0.70, oilAlphaGamma: 1.30, marangoniKth: 1.2, marangoniEdgeBand: 3.0, surfaceTension: 0.0003, oilOverflowUpper: 0.92, oilOverflowLower: 0.77, occupancyEveryN: 150 } }
        ];
