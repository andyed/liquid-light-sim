...
export default class Controller {
    constructor(simulation, renderer) {
        ...
        this.materials = [
            ...
            { name: 'Alcohol', palette: ['#BDE0FE', '#A2D2FF', '#CDB4DB', '#FFC8DD', '#FFAFCC'], preset: { oilViscosity: 0.1, oilViscosityIterations: 20, couplingStrength: 0.6, absorption: 1.5, paletteDom: 0.20, refractStrength: 0.007, fresnelPower: 2.8, oilOcclusion: 0.10, oilAlphaGamma: 0.90, marangoniKth: 0.4, marangoniEdgeBand: 1.5, surfaceTension: 0.0001, oilOverflowUpper: 0.91, oilOverflowLower: 0.76 } },
