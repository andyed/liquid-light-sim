...
export default class Controller {
    constructor(simulation, renderer) {
        ...
        this.materials = [
            ...
            { name: 'Mineral Oil', palette: ['#FFF3C4', '#FFD166', '#F6BD60', '#F7EDE2', '#F28482'], preset: { useOil: true, oilSmoothingRate: 0.0, oilViscosity: 0.75, oilViscosityIterations: 90, couplingStrength: 0.002, absorption: 3.5, paletteDom: 0.12, refractStrength: 0.008, fresnelPower: 3.0, oilOcclusion: 0.25, oilAlphaGamma: 1.10, marangoniStrength: 0.3, marangoniKth: 0.5, marangoniEdgeBand: 2.0 } },
