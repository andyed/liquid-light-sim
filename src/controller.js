...
export default class Controller {
    constructor(simulation, renderer) {
        ...
        this.materials = [
            ...
            { name: 'Alcohol', palette: ['#BDE0FE', '#A2D2FF', '#CDB4DB', '#FFC8DD', '#FFAFCC'], preset: { oilViscosity: 0.15, oilViscosityIterations: 30, couplingStrength: 0.3, absorption: 2.5, paletteDom: 0.20, refractStrength: 0.007, fresnelPower: 2.8, oilOcclusion: 0.30, oilAlphaGamma: 0.90, marangoniKth: 0.4, marangoniEdgeBand: 1.5, surfaceTension: 0.000005 } },
            { name: 'Syrup', palette: ['#8B4513', '#D2691E', '#C97A36', '#F4A261', '#E76F51'], preset: { oilViscosity: 1.5, oilViscosityIterations: 120, couplingStrength: 0.4, absorption: 4.0, paletteDom: 0.12, refractStrength: 0.012, fresnelPower: 3.2, oilOcclusion: 0.60, oilAlphaGamma: 1.20, marangoniKth: 1.0, marangoniEdgeBand: 2.5, surfaceTension: 0.00003 } },
            { name: 'Glycerine', palette: ['#E0FBFC', '#98C1D9', '#3D5A80', '#EE6C4D', '#293241'], preset: { oilViscosity: 1.8, oilViscosityIterations: 100, couplingStrength: 0.45, absorption: 4.5, paletteDom: 0.10, refractStrength: 0.015, fresnelPower: 3.5, oilOcclusion: 0.70, oilAlphaGamma: 1.30, marangoniKth: 1.2, marangoniEdgeBand: 3.0, surfaceTension: 0.00004 } }
        ];
